...
public class Jogador {
  ...
  public static void selectionSort(Jogador array[]) {
    int n = array.length;
    for (int i = 0; i < (n - 1); i++) {
      int menor = i;
      for (int j = (i + 1); j < n; j++){
  ...
  public static void main(String[] args) {
    ...
    selectionSort(jogador);  // ordena vetor pelo nome dos jogadores
    ...
    Arq.openWriteClose("matricula_selecao.txt", conteudo);
  }
}
