...
public class Jogador {
  ...
  public static void insertionSort(Jogador jogador[]) {
    ...
    for (int i = 1; i < n; i++) {
        ...
        while (
          j >= 0 && (numComparacoes+=3) != 0 && (
            jogador[j].getAnoNascimento() > tmp.getAnoNascimento() || (
              jogador[j].getAnoNascimento() == tmp.getAnoNascimento() &&
  ...
  public static void main(String[] args) {
    ...
    insertionSort(jogador);  // ordena vetor pelo nome dos jogadores
    ...
    Arq.openWriteClose("matricula_insercao.txt", conteudo);
  }
}
