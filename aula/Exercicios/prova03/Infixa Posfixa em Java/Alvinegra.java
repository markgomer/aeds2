public class Alvinegra {
   ...
   static class NoAN {
      ...
      public NoAN(char elemento) {
         this(elemento, false, null, null);
      }

      public NoAN(char elemento, boolean cor) {
         this(elemento, cor, null, null);
      }

      public NoAN(char elemento, boolean cor, NoAN esq, NoAN dir) {
         this.cor = cor;
   ...
   private void mostrarPos(NoAN i) {
      if (i != null) {
         ...
         // System.out.print(i.elemento + ((i.cor) ? "(p) " : "(b) ")); // Conteudo do
         // no.
      }
   }
    ...
    * @throws Exception Se o elemento existir.
    */
   private void inserir(char elemento, NoAN bisavo, NoAN avo, NoAN pai, NoAN i) throws Exception {
      if (i == null) {
   ...
   public static void main(String[] args) throws Exception {
      ...
      // ler numero de expressoes
      int N = MyIO.readInt();
      for (int i = 0; i < N; i++) {
         String line = MyIO.readLine();
         for (int cursor = 0; cursor < line.length(); cursor++) {
            arvore.inserir(line.charAt(cursor));
         }
         arvore.mostrarPos();
      }
